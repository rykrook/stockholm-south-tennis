export default {
    ...
    fields: [
        ...
        //bakgrundsinställningar för sektioner
        {
            name: 'programsBackground',
            title: 'Bakgrund: Program-sektionen',
            type: 'backgroundSettings',
        },
        {
            name: 'coachBackground',
            title: 'Bakgrund: Tränar-sektionen',
            type: 'backgroundSettings',
        },
        {
            name: 'testimonialsBackground',
            title: 'Bakgrund: Omdömen',
            type: 'backgroundSettings',
        },
        {
            name: 'bookingBackground',
